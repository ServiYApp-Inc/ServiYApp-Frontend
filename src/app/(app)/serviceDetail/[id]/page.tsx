...
export default async function ServiceDetailPage({ params }: { params: { id: string } }) {
    ...
    return (
        <main className="flex flex-col max-w-4xl mx-auto mt-8">
            ...
            <Link href={"/user/services"} className="max-w-[160px] w-auto bg-[var(--foreground)] text-white p-1 my-1 rounded-lg hover:bg-[var(--color-accent)] hover:text-[var(--foreground)] border transition">  
