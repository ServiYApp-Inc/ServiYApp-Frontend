...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900 text-white py-10 px-4 font-nunito">
          ...
          <div className="space-y-5">
            ...
            <div className="mt-8 bg-gray-800 border border-red-700/40 rounded-2xl shadow-xl p-6 text-right">
              <p className="text-lg font-semibold mb-4">
                Total:{" "}
                <span className="text-red-400">${getTotal().toFixed(2)}</span>
              </p>
